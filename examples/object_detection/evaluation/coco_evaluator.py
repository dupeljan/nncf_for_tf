...
from examples.object_detection.evaluation import coco_utils
...
class COCOEvaluator:
    ...
    def __init__(self, annotation_file, need_rescale_bboxes=True):
        ...
        if annotation_file:
            ...
            self._coco_gt = coco_utils.COCOWrapper(eval_type='box', annotation_file=local_val_json)
